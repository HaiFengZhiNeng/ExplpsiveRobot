package com.example.scout.udp;

import android.content.Context;

import com.example.scout.listener.UdpRegisterRequestListener;
import com.example.scout.listener.UdpServerListener;
...
public class NetClient {
    ...
    public void unregisterUdpServer(){
        if(mSocketManager != null){
            mSocketManager.unregisterUdpServer();
            mSocketManager = null;
        }
    }
