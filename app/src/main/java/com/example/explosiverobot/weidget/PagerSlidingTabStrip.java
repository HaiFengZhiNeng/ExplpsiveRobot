/*
 * Created by 岱青海蓝信息系统(北京)有限公司 on 17-7-7 下午1:48
 * Copyright (c) 2017. All rights reserved.
 */

package com.example.explosiverobot.weidget;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void addTab(final int position, View tab) {
        ...
        if (pager.getAdapter().getCount() < 5) {
...
//                tab.setTextSize(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSizeBigger(tabTextSize));
    ...
    private OnPagerSlidingTabStripChanged pageChanged;

    public void setOnPagerSlidingTabStripChanged(OnPagerSlidingTabStripChanged changed) {
        this.pageChanged = changed;
    }

    public interface OnPagerSlidingTabStripChanged {
    ...
    private class PageListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if (pageChanged != null) {
                pageChanged.onPageChanged(position);
            }
