...
public class MainTouchTextView extends TextView {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (onTimeListener != null) {
                        onTimeListener.onTextTimecount(MainTouchTextView.this, mCount);
                    }
                    if(isDown) {
    ...
    public MainTouchTextView(Context context) {
        super(context);
        init();
    }

    public MainTouchTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MainTouchTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        gd.setCornerRadius(roundRadius);
        gd.setColor(getResources().getColor(R.color.color_main_right_foot));
