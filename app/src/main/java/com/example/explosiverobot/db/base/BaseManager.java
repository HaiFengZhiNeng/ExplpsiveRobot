package com.example.explosiverobot.db.base;
...
import com.example.explosiverobot.db.DaoMaster;
import com.example.explosiverobot.db.DaoSession;
import com.example.explosiverobot.db.interfaces.IDatabase;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "ffb.db";
